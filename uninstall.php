...
$options = [
    'tinify_api_key', 'tinify_auto_optimize', 'tinify_seo_alt_text',
    'tinify_optimize_thumbnails', 'tinify_pipeline_settings',
];
...
$meta_keys = [
    '_tinify_status', '_tinify_job_id', '_tinify_original_size',
    '_tinify_processed_size', '_tinify_savings_pct', '_tinify_optimized_at',
    '_tinify_error', '_tinify_orig_backup',
];
